...
{{--                                            Nota--}}
{{--                                        </a>--}}
                                        <a href="javascript:;" class="btn btn-primary d-block d-sm-none  me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_nota">Nota</a>
                                        <a href="javascript:;" class="btn btn-light-primary d-none d-sm-block  me-3" data-bs-toggle="modal" data-bs-target="#kt_modal_nota">Nota </a>
                                    ...
                                    @if(!empty($listaTipoNotas))
                                        <a href="{{route('diario.mediabim.turma.disciplina.periodo',['turma' => $turma->id,'disciplina' => $disciplina->id,'periodo' => $periodos[0]->id])}}" class="btn  btn-danger d-block d-sm-none">Média</a>
                                        <a href="{{route('diario.mediabim.turma.disciplina.periodo',['turma' => $turma->id,'disciplina' => $disciplina->id,'periodo' => $periodos[0]->id])}}" class="btn  btn-light-danger d-none d-sm-block">Média</a>
                                    @else
                            ...
                            <div class="card-header border-0 pt-5">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    @if(!$mediasSalvas->get(1)['salvo'])
                                        <!--begin::Menu-->
                                        <a href="{{route('diario.notas.turma.disciplina.periodo',['turma' => $turma->id,'disciplina' => $disciplina->id,'periodo' => $periodos[1]->id])}}" class="btn  btn-light-primary me-3">
                                    ...
                                    @endif
                                    @if(!empty($listaTipoNotas))
                                        <a href="{{route('diario.mediabim.turma.disciplina.periodo',['turma' => $turma->id,'disciplina' => $disciplina->id,'periodo' => $periodos[1]->id])}}" class="btn  btn-light-danger">
                                            <!--begin::Svg Icon | path: icons/duotune/general/gen024.svg-->
                                            Média
                                            <!--end::Svg Icon-->
                                        </a>
            ...
            <div class="modal-dialog modal-lg modal-fullscreen2">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body mx-xl-10 pt-0 pb-0" >
                        <form action="{{route('diario.nota.cadastrar')}}" id="formulario" method="post">
                        <!--begin::Heading-->
                            ...
                            <div class="mb-15" >
                                ...
                                <div class="row g-5">
                                        ...
                                        <div class="col-6 fv-row ">
                                            ...
                                            <label class="required fs-6 fw-bold mb-1">Data da nota</label>
                                            <!--begin::Input-->
                                            <div class="position-relative d-flex align-items-center">
                                                ...
                                                <!--end::Icon-->
                                                <!--begin::Datepicker-->
                                                <input class="form-control form-control-solid ps-12"placeholder="Selecione" name="data" id="data_nota"/>
                                                <!--end::Datepicker-->
                                            </div>

                                            <!--end::Input-->
                                        </div>
                                        <div class="col-6 fv-row pb-8">
                                            <label class="required texto fw-bold mb-1">Tipo de Avaliação</label>
                                            <select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Selecione" name="tipo" id="tipo">
...
{{--                                                    <span class="badge badge-light fs-8 fw-semibold ms-2">Marketing Analytic</span>--}}
                    ...
                    <div class="modal-footer my-3">
                        ...
                        <button {{$mediasSalvas ? "disabled='disabled'":""}}  type="submit" class="btn btn-primary" id="btn_salvar_notas">
